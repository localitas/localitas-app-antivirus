...
import (
	...
	"github.com/localitas/localitas-app-antivirus"
...
func main() {
	if len(os.Args) > 1 && (os.Args[1] == "--version" || os.Args[1] == "version") {
		fmt.Printf("antivirus-server %s (commit: %s)\n", version, commit)
		os.Exit(0)
	}
	...
	go antivirus.RegisterScanAutomation(*coreURL, *token, selfURL)
